...
const categories = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1531572753322-ad063cecc140?q=80&w=800",
    packages: [
    ...
    <div className="min-h-screen pt-20 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300">Discover our curated collection of travel experiences</p>
        </motion.div>
